    ...
    <form method="POST" action="<?php echo $this->getFormUrl(); ?>" id="attribute-form">
        <div class="col-md-4" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <select name="attribute[backEndModel]" required="" class="form-control selectpicker" tabindex="-98">
                    <option value="">Select..</option>
                    <?php foreach ($attribute->getEntityTypeIdOptions() as $key => $value) { ?>
                    <option value="<?php echo $key ?>" <?php if ($attribute->entityTypeId == $key) { ?> selected
                        <?php } ?>>
        ...
        <div class="row justify-content-start">
            <div class="col-md-6" style="margin-top: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" name="attribute[backEndType]" required="" class="form-control"
                        value="<?php echo $attribute->backEndType ?>">
                </div>
            </div>
        </div>
